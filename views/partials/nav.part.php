            ...
            <ul class="nav navbar-nav">
              ...
              <?php if (!isset($_SESSION["username"])):?>
                <li class="<?= (esOpcionMenuActiva("login")? "active" : "");?> lien">
                  <a href="<?= (esOpcionMenuActiva("login")? "#" : "/login.php");?>"><i class="fa fa-image sr-icons"></i> Login</a>
                </li>
                <li class="<?= (esOpcionMenuActiva("register")? "active" : "");?> lien">
                  <a href="<?= (esOpcionMenuActiva("register")? "#" : "/register.php");?>"><i class="fa fa-image sr-icons"></i> Registro</a>
                </li>                              
              <?php else:?>
                ...
                <li class="<?= (esOpcionMenuActiva("logout")? "active" : "");?>">
                  <a href="<?= (esOpcionMenuActiva("logout")? "#" : "/logout.php");?>"><i class="fa fa-hand-o-right sr-icons"></i> <?=$_SESSION["username"]?> - Salir</a>
                </li>
              <?php endif ?>
            </ul>
        </div>
